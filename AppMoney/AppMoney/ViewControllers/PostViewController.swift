...
class PostViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        // 基本設定
        self.title = "新增"
        self.view.backgroundColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1)
        ...
        if let mydb = db {
            ...
            myTextField.backgroundColor = UIColor(red: 0.05, green: 0.05, blue: 0.05, alpha: 1)
            ...
            saveBtn.backgroundColor = UIColor(red: 0.88, green: 0.83, blue: 0.73, alpha: 1)
    ...
    @objc func deleteBtnAction() {
        ...
        let okAction = UIAlertAction(title: "刪除", style: .default) { (result) in
            if let mydb = self.db {
